        ...
        <div className="my-8 lg:px-12 w-full h-auto">
            <div>
                <h1 className="text-5xl font-semibold text-center text-[#0b2545]">
                    Our Charter Jet Rental Services
                </h1>

                {/* Nav tabs */}
                <div className="/lg:mx-4 md:px-12 mt-8  flex flex-wrap justify-center md:justify-start space-y-2 md:space-y-2">
                    <button
                        className={`w-full md:w-[15%] h-16 ${activeTab === 'private-jet' ? 'bg-[#0b2545] text-white' : 'bg-gray-300 text-black'} md:mt-2 mx-2 lg:mx-1`}
                        onClick={() => handleTabClick('private-jet')}
                    >
                        Private Jet Rental
                    </button>
                    <button
                        className={`w-full md:w-[15%] h-16 ${activeTab === 'empty-leg' ? 'bg-[#0b2545] text-white' : 'bg-gray-300 text-black'} md:mt-2 mx-2 lg:mx-1`}
                        onClick={() => handleTabClick('empty-leg')}
                    >
                        Empty Leg Flights
                    </button>
                    <button
                        className={`w-full md:w-[15%] h-16 ${activeTab === 'helicopter' ? 'bg-[#0b2545] text-white' : 'bg-gray-300 text-black'} md:mt-2 mx-2 lg:mx-1`}
                        onClick={() => handleTabClick('helicopter')}
                    >
                        Helicopter Rental
                    </button>
                    <button
                        className={`w-full md:w-[15%] h-16 ${activeTab === 'concierge' ? 'bg-[#0b2545] text-white' : 'bg-gray-300 text-black'} md:mt-2 mx-2 lg:mx-1`}
                        onClick={() => handleTabClick('concierge')}
                    >
                        Concierge Services
                    </button>
                    <button
                        className={`w-full md:w-[15%] h-16 ${activeTab === 'air-cargo' ? 'bg-[#0b2545] text-white' : 'bg-gray-300 text-black'} md:mt-2 mx-2 lg:mx-1`}
                        onClick={() => handleTabClick('air-cargo')}
                    >
                        Air Cargo Transports
                    </button>
                    <button
                        className={`w-full md:w-[15%] h-16 ${activeTab === 'jet-cards' ? 'bg-[#0b2545] text-white' : 'bg-gray-300 text-black'} md:mt-2 mx-2 lg:mx-1`}
                ...
                <div className="tab-content mt-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 m-4 md:px-12">
                        <div>
                            ...
                            <button className="bg-yellow-500 w-full text-lg sm:text-xl md:text-2xl lg:text-lg md:w-3/5 md:font-semibold rounded-sm h-12 mt-12 font-semibold text-white hover:bg-yellow-600">
                                Learn More
                            </button>
                        </div>
                        <div>
